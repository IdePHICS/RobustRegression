...
from robust_regression.aux_functions.misc import (
    estimation_error,
    excess_gen_error,
    gen_error_BO,
    angle_teacher_student,
    estimation_error_oracle_rescaling,
    excess_gen_error_oracle_rescaling
)
import numpy as np
...
fname_files = "{}_Figure_1_left_rescaling_lambda_{}.npz"
...
(
    ...
    funs=[excess_gen_error_oracle_rescaling, sigma_order_param, q_order_param, m_order_param],
    funs_args=[
        {
            "delta_in": delta_in,
            "delta_out": delta_out,
